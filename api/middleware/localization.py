...
def get_patient_preferred_language(patient_id: str, fallback: str = "en") -> str:
    # English-only mode requested: ignore stored language preferences.
    return "en"

def _legacy_get_patient_preferred_language(patient_id: str, fallback: str = "en") -> str:
    try:
...
async def get_patient_preferred_language_async(patient_id: str, fallback: str = "en") -> str:
    # English-only mode requested: keep all API responses in English.
    return "en"

async def _legacy_get_patient_preferred_language_async(patient_id: str, fallback: str = "en") -> str:
