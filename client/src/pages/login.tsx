  ...
  return (
    <div className="min-h-screen flex bg-[var(--bg-base)] text-[var(--text-primary)] font-sans relative overflow-hidden">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .login-custom-checkbox[data-checked="true"] {
          background: var(--accent-cyan);
          border-color: var(--accent-cyan);
        }
      `}} />
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="login-feature-card p-4 rounded-xl flex items-start gap-4 cursor-default"
          ...
          <div className="bg-[var(--bg-card)] rounded-2xl p-8 border border-[var(--border-subtle)] shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative login-input-wrapper bg-[var(--bg-base)] rounded-lg border border-[var(--border-default)] overflow-hidden transition-colors hover:border-[var(--border-strong)] focus-within:border-[var(--border-strong)]">
                  <input
                    type="email"
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    ...
                    className="w-5 h-5 login-custom-checkbox rounded border-2 border-[var(--border-strong)] flex items-center justify-center bg-transparent group-hover:border-[var(--accent-cyan)] group-focus-visible:ring-2 group-focus-visible:ring-[var(--accent-cyan-dim)]"
                  >
              ...
              <button
                ...
                className="w-full h-12 rounded-xl login-btn-gradient text-white font-semibold flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
              >
                {loading ? (
